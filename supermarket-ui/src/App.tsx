    ...
    <div className="min-h-screen bg-[#f2f0eb] font-sans text-[#1E3932] tracking-[-0.01em]">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-8">
            ...
            <div className="flex-1 max-w-2xl hidden md:block relative">
              ...
              <Button
                size="icon"
                className="absolute right-1 top-1 rounded-full bg-[#00754A] hover:bg-[#006241] h-10 w-10 text-white"
              >
            ...
            <div className="flex items-center gap-4">
              <Button
                variant="ghost"
                size="icon"
                className="text-[#1E3932] hover:bg-[#D4E9E2] rounded-full h-12 w-12 transition-transform active:scale-95"
              >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="text-[#1E3932] hover:bg-[#D4E9E2] rounded-full h-12 w-12 transition-transform active:scale-95 relative"
              >
                <ShoppingBag className="h-6 w-6" />
                <span className="absolute top-2 right-2 h-4 w-4 rounded-full bg-[#00754A] text-white text-[10px] font-bold flex items-center justify-center">
                  3
                </span>
              </Button>
              <Button
          ...
          <nav className="hidden md:flex items-center gap-8 mt-4 pt-4 border-t border-[#006241]/10 text-sm font-semibold text-[#1E3932]">
            <Button
              variant="ghost"
              className="hover:bg-[#D4E9E2] text-[#006241] rounded-full px-6 gap-2"
            >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="text-5xl md:text-6xl font-bold leading-tight tracking-tight">
                ...
                <span className="text-[#D4E9E2]">Quality Groceries</span>
              </h1>
              <p className="text-lg text-white/80 max-w-lg leading-relaxed">
                Fresh produce, daily essentials, and premium ingredients
                delivered straight to your door. Experience the joy of cooking
                with the finest selections.
              </p>
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Button
                  variant="outline"
                  className="bg-transparent border-white/30 text-white hover:bg-white/10 rounded-full px-8 py-6 text-lg font-semibold transition-transform active:scale-95"
                >
                  View All Products
                </Button>
              </div>
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="flex items-end justify-between mb-10">
          <h2 className="text-3xl font-bold text-[#1E3932] tracking-tight">
            Featured Categories
          </h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {[
            ...
            <div
              key={i}
              className="flex flex-col items-center p-6 bg-white rounded-3xl shadow-[0_0_0.5px_rgba(0,0,0,0.14),0_1px_1px_rgba(0,0,0,0.24)] hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer group"
            >
              <div
                className={`w-20 h-20 rounded-full flex items-center justify-center mb-4 ${cat.color} group-hover:scale-110 transition-transform`}
              >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-[#D4E9E2] border-none shadow-[0_0_0.5px_rgba(0,0,0,0.14),0_1px_1px_rgba(0,0,0,0.24)] rounded-3xl overflow-hidden relative group">
            <CardContent className="p-8 md:p-12 flex flex-col justify-center h-full relative z-10 w-2/3">
              <Badge className="w-fit bg-[#006241] hover:bg-[#006241] text-white mb-4">
                Flat 20% Discount
              </Badge>
              <h3 className="text-3xl font-bold text-[#1E3932] mb-2">
                Purely Fresh Vegetables
              </h3>
              <p className="text-[#1E3932]/80 mb-6 font-medium">
                Farm fresh to your table every day.
              </p>
            ...
            <img
              ...
              className="absolute right-0 top-0 h-full w-1/2 object-cover object-left mask-image-to-l group-hover:scale-105 transition-transform duration-500"
              alt="Vegetables"
            />
          </Card>
          ...
          <Card className="bg-[#fce5cd] border-none shadow-[0_0_0.5px_rgba(0,0,0,0.14),0_1px_1px_rgba(0,0,0,0.24)] rounded-3xl overflow-hidden relative group">
            <CardContent className="p-8 md:p-12 flex flex-col justify-center h-full relative z-10 w-2/3">
              <Badge className="w-fit bg-[#cba258] hover:bg-[#cba258] text-white mb-4">
                Weekend Special
              </Badge>
              <h3 className="text-3xl font-bold text-[#1E3932] mb-2">
          ...
          {[
            {
              ...
              weight: "1 kg",
              cat: "Fruits",
              img: "https://images.unsplash.com/photo-1571501711155-87ea2d46e017?auto=format&fit=crop&q=80&w=300",
            },
            {
              ...
              weight: "500 g",
              cat: "Vegetables",
              img: "https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?auto=format&fit=crop&q=80&w=300",
            },
            {
            ...
            <Card
              key={i}
              className="bg-white border-none shadow-[0_0_0.5px_rgba(0,0,0,0.14),0_1px_1px_rgba(0,0,0,0.24)] rounded-[12px] overflow-hidden group"
            >
              <div className="relative">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="absolute top-3 right-3 z-10 bg-white/80 hover:bg-[#D4E9E2] text-gray-500 hover:text-[#00754A] rounded-full h-10 w-10"
                >
                ...
                <div className="h-[220px] bg-gray-50 p-4 flex items-center justify-center overflow-hidden">
                  <img
                    src={prod.img}
                    alt={prod.name}
                    className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 rounded-xl mix-blend-multiply"
                  />
                </div>
              </div>
              <CardContent className="p-5">
                <p className="text-xs font-semibold text-[#006241] uppercase tracking-wider mb-2">
                  {prod.cat}
                </p>
                <h3 className="font-bold text-[#1E3932] text-lg mb-1 leading-tight line-clamp-2">
                  {prod.name}
                </h3>
                ...
                <div className="flex items-center gap-1 mb-3">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <Star
                      key={s}
                      className="w-4 h-4 fill-[#cba258] text-[#cba258]"
                    />
                  ))}
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <Button
                    size="icon"
                    className="rounded-full h-12 w-12 bg-[#00754A] hover:bg-[#006241] text-white transition-transform active:scale-95 shadow-md shadow-[#00754A]/20"
                  >
        ...
        <div className="container mx-auto px-4">
          <div className="bg-[#006241] rounded-[24px] overflow-hidden relative shadow-2xl flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/3 h-64 md:h-auto">
              <img
                src="https://images.unsplash.com/photo-1490818387583-1baba5e638ce?auto=format&fit=crop&q=80"
            ...
            <div className="w-full md:w-1/3 p-10 flex flex-col items-center text-center z-10">
              <Badge className="bg-[#D4E9E2] text-[#006241] hover:bg-[#D4E9E2] mb-4 border-none text-sm px-4 py-1">
                Summer Discount
              </Badge>
              ...
              <div className="flex gap-4 mb-8">
                {[
                  ...
                  <div key={i} className="flex flex-col items-center">
                    ...
                    <span className="text-white/80 text-xs uppercase font-medium tracking-wider">
                      {time.label}
                    </span>
                  </div>
                ))}
